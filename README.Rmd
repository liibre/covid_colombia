...
fecha <- vroom::vroom("./data/Casos_positivos_de_COVID-19_en_Colombia_corregido.csv", col_select = "fecha reporte web")
...
Para saber más sobre el análisis de corrección de atrasos de notificación por _nowcasting_ bayesiano, visite [https://covid19.br.github.io](https://covid19.br.github.io) 
